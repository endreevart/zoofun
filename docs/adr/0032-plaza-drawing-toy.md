# ADR-0032: Personal drawing-toy in DIY construction zoos

- Status: accepted (revised 2026-09-21)
- Date: 2026-09-19
- Revised: 2026-09-21
- Relates: D-016, D-020, D-021, D-023, D-024, D-026, D-029, D-031, ADR-0006, ADR-0029

## Context

Families asked to put a child's own drawing onto the lawn, not only catalog GLBs. D-029 hid original drawings and let anyone edit every stamp on the shared lawn. A paid personal object cannot stay that open. The first cut was a still standee on the shared lawn so 59 ₽ would not undercut `pack_1`. The product now grows that paid toy into a Tripo mesh **without** spending a creature 3D credit, and places it in **purchased DIY construction copies** (D-020 / D-021) while the shared lawn is hidden from the picker.
...
- D-029 picker banner is off (`PLAZA_PUBLIC`); personal toys live in DIY garden JSON.
