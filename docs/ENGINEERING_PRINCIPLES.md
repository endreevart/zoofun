...
4. **Server owns generation state.** Job transitions and ready assets are authoritative on the backend. There is no credit balance in this pilot.
...
- Do not add payment, StoreKit, or credit-ledger tests: those features are deferred/post-pilot.
