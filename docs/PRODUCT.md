...
3. The first Zufik waits as an egg while the 3D mesh finishes. Later drawings show a postcard on the hatch screen and live in «Мои зуфики» until leftover 3D starts Tripo on hatch «В сад!» or roster «В сад»; otherwise «Оживить» or PackSheet (D-031). The lawn egg appears only when that 3D starts. While the first egg waits, the child can assemble a jigsaw puzzle of the painted still (4 pieces, then 9).
...
Original drawings and original pet photos stay inside the parent account. No chat, friends list, or search for a child. A family may share a garden link; guests walk a snapshot, like the lawn and Zufiks with hearts, and open the same album without download (D-028). The vitrine lists gardens by joy. A child may take a living Zufik onto a shared lawn when that lawn is listed (`PLAZA_PUBLIC`, D-029); the lawn holds up to 400 stamps and the oldest catalog tree vanishes when a new one needs room; other families see the hosted mesh or a stylized still, never the original drawing. A parent may pay for a 3D object of the child's drawing in a purchased DIY construction zoo (D-032); other families never see the paper. Every family island keeps smashable crystals; two generation credits a day may hide on one random family island (D-030). Once a day a treasure chest may sit on one random family island until it is opened; inside is a readable fact from «Открытия ЗУФАН» (D-036). The garden jump-run (D-037) stays in code behind `RUN_PUBLIC`; the stone plinth is off the public lawn for now. A tap on a family Zufik also opens the same six pictograms as the shared lawn; they puff over that creature and stay local (no plaza post, no chat). Anonymized garden postcards may still appear on the public site (D-022).

## Commercial model

**Status: accepted (D-016 / ADR-0006).**

The first creature on a parent account is a free 3D revive, and that family also starts with ten free stills (postcard harmonizations). Further 3D uses generation credits sold as one-time packs of 1, 5, 10, 15, or 20 animals; each extra 3D slot adds ten stills (`still_quota = 10 + 10 * max(0, quota_total - 1)`, D-031). Two extra 3D credits a day may be found by smashing crystals on one random family island (D-030). After the free hatch the island first offers one more Zufik or a pack of five; larger packs stay one tap away. A drawing can also become a 3D object in a DIY construction zoo for 59 ₽ (`plaza_toy_1`, D-032); that purchase is not a creature 3D credit. The child may place copies of that object without a per-toy limit. The island shows the painted still before that gift sheet. Prices are in rubles and shown in the UI at checkout. Payment is internet acquiring through АО «ТБанк». Deleting a creature does not restore a 3D credit or a still. There are no subscriptions, StoreKit, or App Store IAP. «Волшебный остров» is the free ready world. The first empty garden («Собери сам») is granted free and opens as a short voice-led arcade (D-027). Extra garden copies, plus meadow and grove construction copies, may be bought more than once (D-020 / D-021). A later island kind is a new row with its own assets. Foreign acquiring and other currencies come later.
