...
Original drawings and original pet photos stay inside the parent account. No chat, friends list, or search for a child. A family may share a garden link; guests walk a snapshot, like the lawn and Zufiks with hearts, and open the same album without download (D-028). The vitrine lists gardens by joy. A child may take a living Zufik onto a shared lawn, show pictograms, and build catalog trees and houses that every visitor sees (D-029); the lawn holds up to 400 stamps and the oldest catalog tree vanishes when a new one needs room; other families see the hosted mesh or a stylized still, never the original drawing. A parent may pay for a 3D object of the child's drawing on that lawn (D-032); other families see the generated still or mesh, never the paper. Crystals on that lawn can hide a generation credit from a shared pool of eight per day (D-030). Anonymized garden postcards may still appear on the public site (D-022).
